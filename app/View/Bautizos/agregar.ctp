...
<table class="tform">
    ...
    <tr>
        <td><?php echo $this->Form->input('pais_nacimiento', array('label' => 'País de nacimiento', 'type' => 'select', 'options' => $paises, 'selected' => 'Venezuela')); ?></td>
        <td><?php echo $this->Form->input('estado_nacimiento', array('label' => 'Estado de nacimiento', 'type' => 'select', 'options' => $estados, 'selected' => $estado_selected)); ?></td>
    </tr>
    <tr>
        <td><?php echo $this->Form->input('ciudad_nacimiento', array('label' => 'Ciudad de nacimiento', 'type' => 'select', 'options' => $ciudades, 'selected' => $ciudad_selected)); ?></td>
