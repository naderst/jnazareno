...
<table class="tform">
    ...
    <tr>
        <td><div><label for="PersonaNombres">Nombres</label><br><input type="text" name="data[Persona][nombres]" id="PersonaNombres"></div></td>
        <td><div><label for="PersonaApellidos">Apellidos</label><br><input type="text" name="data[Persona][apellidos]" id="PersonaNombres"></div></td>
    </tr>
    <tr>
        <td><div><label for="PersonaCedula">Cédula</label><br><input type="text" name="data[Persona][cedula]" id="PersonaCedula" onfocus="javascript:cedula(this);" onblur="javascript:nocedula(this);"></div></td>
    ...
    <tr>
        <td><div><label for="PersonaPaisNacimiento">País de nacimiento</label><br><select name="data[Persona][pais_nacimiento]" id="PersonaPaisNacimiento">
...
<option value="Zimbabue">Zimbabue</option>
        ...
        <td><div><label for="PersonaEstadoNacimiento">Estado de nacimiento</label><select name="data[Persona][estado_nacimiento]" id="PersonaEstadoNacimiento">
 <option>Amazonas</option>
  ...
  <option>Vargas</option>
    ...
    <tr>
        ...
        <td><div><label for="PersonaDireccion">Dirección actual</label><br><input type="text" id="PersonaDireccion" name="data[Persona][direccion]"></div></td>
    </tr>
    <tr>
        <td>Ciudad</td>
        <td>Estado</td>
